...
-   Across mitigatable activity groups, coverage of parameters ranges from 51.8% (*Emergency department and acute medicine activity*) to 58.4% (*Planned medical activity (adult)*).
-   Both Frimley and Leighton have selected amongst the fewest parameters of all schemes (34 and 25, respectively). This contrasts to PAH and Hinchingbrooke which have both selected 84.
...
-   *Planned surgical activity (adult)* contains the largest proportion of high ambition assumptions (52, 21.0%), whilst *Hospital activity amenable to psychiatric liaison and community psychiatry* contains the largest proportion of low ambition assumptions (18, 47.4%).
-   Leighton’s average ambition amongst its parameters is in the top half of all schemes at 0.81 whilst Frimley has the fourth lowest ambition of all schemes at 0.9.
...
-   Frimley and Leighton are near opposite ends of the schemes in terms of their average uncertainty range, with Frimley having an average interval width of 0.06 and Leighton 0.16.
<!-- -   James Paget has shown the largest average uncertainty range in its selections (0.22) of all schemes, with the remaining three schemes being around the middle of all schemes and close clustered to one another (0.11 to 0.14) -->
...
-   Frimley has the lowest proportion of its parameters meeting or exceeding NEE ambition of all schemes at only 2.9%, whilst Leighton is more middling with 20.0%.
