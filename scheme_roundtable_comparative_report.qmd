...
|-----------------------|----------------|--------------|
| Activity Avoidance    | `r item_7`%    | `r item_8`%  |
| Efficiency Mitigation | `r item_9`%    | `r item_10`% |
| All Mitigation        | `r item_11`%   | `r item_12`% |

: Inpatients

|                       | All attendances (F2F and virtual) |
|-----------------------|-----------------------------------|
| Activity Avoidance    | `r item_13`%                      |
| Efficiency Mitigation | `r item_14`%                      |
| All Mitigation        | `r item_15`%                      |

: Outpatients

|                       | A&E attendances |
|-----------------------|-----------------|
| Activity Avoidance    | `r item_16`%    |
| Efficiency Mitigation | `r item_17`%    |
| All Mitigation        | `r item_18`%    |
